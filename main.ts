...
function attackCheck () {
    while (tempVar < 1) {
        if (direction == "up") {
            ...
            animation.stopAnimation(animation.AnimationTypes.All, mainPlayer)
            animation.setAction(mainPlayer, ActionKind.Attack)
        }
...
function setAnim () {
    anim_walk_right = animation.createAnimation(ActionKind.walkingRight, 200)
    ...
    anim_walk_right.addAnimationFrame(img`
        ...
        . . . . . f f . . . f f f . . . 
        `)
    anim_walk_left = animation.createAnimation(ActionKind.walkingLeft, 200)
    ...
    anim_walk_left.addAnimationFrame(img`
        ...
        . . . f f f . . . f f . . . . . 
        `)
    anim_walk_up = animation.createAnimation(ActionKind.walkingUp, 200)
    ...
    anim_walk_up.addAnimationFrame(img`
        ...
        . . . . . . . . . f f f . . . . 
        `)
    anim_walk_down = animation.createAnimation(ActionKind.walkingDown, 200)
    ...
    anim_walk_down.addAnimationFrame(img`
        ...
        . . . . . . . . . f f f . . . . 
        `)
    anim_right_attack = animation.createAnimation(ActionKind.Attack, 100)
